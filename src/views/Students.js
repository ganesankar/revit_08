...
export default class Students extends Component {
  ...
  componentDidMount() {
    // Fetch all todos
    api.readAllStudents().then((todos) => {
  ...
  saveTodo = (e) => {
    ...
    api.createStudent(todoInfo).then((response) => {
  ...
  clearCompleted = () => {
    ...
    this.setState({
      ...
      api.batchDeleteStudents(data.completedTodoIds).then(() => {
